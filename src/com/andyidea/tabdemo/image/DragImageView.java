...
public class DragImageView extends ImageView {
	...
	private int current_Top = 0, current_Right = 667, current_Bottom = 333, current_Left = 0;// 当前图片上下左右坐标
	...
	public int getcurrent_Top() {  
        return current_Top;  
    } 
	public int getcurrent_Bottom() {  
        return current_Bottom;  
    }
	public int getcurrent_Left() {  
        return current_Left;  
    }
	public int getcurrent_Right() {  
...
//		int disY = (int) (this.getHeight() * Math.abs(1 - scale)) / 4;// 获取缩放垂直距离
		...
		int disX = (int) (this.getWidth() * Math.abs(1 - scale)) / 5;// 获取缩放水平距离
		int disY = (int) (this.getHeight() * Math.abs(1 - scale)) / 5;// 获取缩放垂直距离
