...
public class TLEDraw {
	...
	public static void drawMapSatellite(Canvas canvas, Bitmap satmap,String name, LLA lla,int cx, int cy, int width, int high,Paint paint,boolean cur) {
	...
	public static void drawPolarSatellite(Canvas canvas, Bitmap satmap,String name,LLA lla,int cx, int cy, int r,Paint paint,boolean cur) {
